...
# A CHANGER SI BESOIN DE FUSIONNER D AUTRES JSON
files = [
...
# Lecture du schema et on met dans un DF le premier fichier json
...
output_final_file = "ressources/data_output/gen9ubers.json"
